%% Required m-files for ShearPredictions_rev2.m:
%     Z:\Ben Yeoman\Matlab\ComsolShears.mat
%     Z:\Ben Yeoman\Matlab\custom\fancyPlot.m
%% Required MATLAB Toolboxes for ShearPredictions_rev2.m:
...
l=legend(p1(1:(c-1)),{'0%%','50%%','100%%'},'Location','best');
l.EdgeColor = [1,1,1];
l.FontSize = 18;
