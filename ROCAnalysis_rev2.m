%% Required m-files for ROCAnalysis_rev2.m:
%     sheardata.mat
%% Required MATLAB Toolboxes for ROCAnalysis_rev2.m:
...
biop = 1;   %Biopsy, 1 for tumor, 2 for stroma, 3 for single fit tumor, 4 for single fit stroma
